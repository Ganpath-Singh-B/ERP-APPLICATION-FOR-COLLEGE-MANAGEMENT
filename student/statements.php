   ...
   <img src="images/abc.png" width="300" height="50" alt="" style="background-color: white;"> 
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item active"> <a class="nav-link" href="statements.php"> Details</a></li>
    ...
    <tr>
      ...
      <th scope="col"><?php echo $userData1['usn']; ?></th>
          ...
          <tbody>
            ...
            $query = mysqli_query($con, "select * from attendance where id = '$_SESSION[userId]'");
            ...
            if ($rows != 0) {
              ...
              while ($row = $query->fetch_array()) {
                ...
                echo "<td>" . $row['subname'] . "</td></tr>";

                echo "<tr><th scope='row'>" . 'Subject Code' . "</th>";
                echo "<td>" . $row['subcode'] . "</td></tr>";

                echo "<tr><th scope='row'>" . 'Faculty Name' . "</th>";
                echo "<td>" . $row['facaultyname'] . "</td></tr>";

                echo "<tr><th scope='row'>" . 'Status' . "</th>";
                echo "<td>" . $row['status'] . "</td></tr>";

                echo "<tr><th scope='row'>" . 'IA-1' . "</th>";
                echo "<td>" . $row['ia1'] . "</td></tr>";

                echo "<tr><th scope='row'>" . 'IA-2' . "</th>";
                echo "<td>" . $row['ia2'] . "</td></tr>";

                echo "<tr><th scope='row'>" . 'IA-3' . "</th>";
                echo "<td>" . $row['ia3'] . "</td></tr>";
              }
            }
            ?>
