<form class="form-inline my-2 my-lg-0">
        ...
        <a href="accounts.php" data-toggle="tooltip" title="Account Details" class="btn btn-outline-primary mx-1" ><i class="fa fa-book fa-fw"></i></a> 
        ...
        <a href="feedback.php" data-toggle="tooltip" title="FeedBack" class="btn btn-outline-info mx-1" ><i class="fa fa-question fa-fw"></i></a> 
